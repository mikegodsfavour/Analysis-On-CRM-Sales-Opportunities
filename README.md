...
The dataset was originally provided in a ZIP file containing CSV tables. I exported them into Excel worksheets and combined them into a single file for analysis. The dataset included four main tables: Accounts, Products, Sales Teams, and Sales Opportunities.

**The following steps were carried out to prepare the dataset for analysis:**

- *File Preparation:* Converted CSV files into Excel worksheets.

- *Data Integration:* Used VLOOKUP to merge tables based on unique identifiers such as Opportunity ID, Account, Product, and Sales Agent.

- *Handling Missing Data:* Removed incomplete or irrelevant entries to ensure accuracy.

- *Dataset Structuring:* Created a master table (Sales Pipeline) that carried all relevant columns.

**KPI Creation**

To support the analysis, I developed key performance indicators (KPIs):

  - *Number of Deals:* The total count of opportunities in the pipeline. This shows overall sales activity.

`Count Of Opportunity ID = 6,117`

  - *Total Revenue:* The sum of revenue values across all opportunities. This highlights financial performance.

 `Sum Of Revenue = $15,004,001.90` 

**KPI Questions Answered**

The cleaned dataset and KPIs were then used to answer the following business questions:

- *How is each sales team performing compared to the rest?*

This looks at revenue contribution by each team (manager and their agents) to identify top and low performers.

- *Are any sales agents lagging behind?*

This focuses on revenue by sales agent, helping to spot individuals with lower results who may need support.

- *Can you identify any quarter-over-quarter trends?*
  
This groups revenue by quarter to show seasonal patterns, e.g., Q2 performing highest and Q1 lowest.

- *Do any products have better win rates?*

This compares products by deal stages (Engaging, Prospecting, Lost, Won) to find which products close more successfully.

- *Which product generated the most revenue?*

This highlights revenue contribution by product, showing leaders like GTX Basic and lower performers such as GTK 500.

- *How is Sales performance distributed across managers*

This measures revenue generated by each manager to identify who leads the most productive teams.

These KPIs and questions formed the foundation of the pivot tables, pivot charts, and dashboard that provided actionable insights into the company’s sales pipeline.
...
**6. How is Sales performance distributed across managers**
...
![](https://github.com/mikegodsfavour/Analysis-On-CRM-Sales-Opportunities/blob/main/sales%20performance%20by%20each%20manager.png)
